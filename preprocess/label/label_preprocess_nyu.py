...
def main(config):
    ...
    for split in ["train", "test"]:
        root = os.path.join(config.data_root, 'depthbin', "NYU" + split)
        base_dir = os.path.join(config.preprocess_root, "base", "NYU" + split)
        ...
        for scan in tqdm(scans):
            ...
            target_1_8 = _downsample_label(target_1_1, scene_size, 8)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate Lable for NYUv2')
    parser.add_argument('--data_root', type=str, default='/home/jm/Downloads/Compressed/nyu/NYU_dataset')
    parser.add_argument('--preprocess_root', type=str, default='/home/jm/Downloads/Compressed/nyu/NYU_dataset')
